...
public class CrawlSearchRecursiveAction extends RecursiveAction {
    ...
    public CrawlSearchRecursiveAction(String url, Clock clock,
                                      Instant deadline, int maxDepth,
    ...
    private List<CrawlSearchRecursiveAction> createSubTasks(List<String> subLinks) {
        ...
        for(String subUrl : subLinks){
            CrawlSearchRecursiveAction crawlSearchRecursiveAction = new CrawlSearchRecursiveAction(
                    subUrl, clock, deadline, maxDepth -1,
                    parserFactory, ignoredUrls, counts, visitedUrls
            );
